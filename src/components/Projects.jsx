...
//                <div key={index} className="mb-8 flex flex-wrap ig:flex-nowrap lg:justify-center">
//                 <motion.div 
...
//          whileInView={{opacity:1,x:0}}
//          initial={{opacity:0, x:100}}
//          transition={{duration:1}} className="w-full max-w-xl lg:w-3/4 pl:4">
...
//               initial={{ opacity: 0, x: 100 }}
//               transition={{ duration: 1 }} 
//               className="w-full max-w-xl lg:w-3/4 pl-4"
//             >
